...
/* ===== HOME SCREEN ===== */
  ...
  changePassKeyboardView: {
    width: '100%',
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
  },
  changePassPressableOverlay: {
    width: '100%',
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
...
export const ComponentTextStyles = StyleSheet.create({
  ...
  changePassBtnCancelText: {
    fontSize: 14,
    fontFamily: 'Montserrat-Bold',
    color: Colors.black,
  },
  changePassBtnSaveText: {
    fontSize: 14,
    fontFamily: 'Montserrat-Bold',
    color: Colors.white,
  },
